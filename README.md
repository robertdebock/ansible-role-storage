...
[![Build Status](https://travis-ci.org/robertdebock/ansible-role-storage.svg?branch=master)](https://travis-ci.org/robertdebock/ansible-role-storage)
...
[Unit tests](https://travis-ci.org/robertdebock/ansible-role-storage) are done on every commit and periodically.
